...
public abstract class AbstractMapEx<K,V> implements Map<K,V> {
    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected AbstractMapEx() {
    }
	...
	if (keySet == null) {
		...
		public int size() {
		    return AbstractMapEx.this.size();
		}

		public boolean contains(Object k) {
		    return AbstractMapEx.this.containsKey(k);
		}
	    };
	}
	return keySet;
	...
	if (values == null) {
		...
		public boolean contains(Object v) {
		    return AbstractMapEx.this.containsValue(v);
		}
	    };
	}
	return values;
    ...
    /**
     * Returns a shallow copy of this <tt>AbstractMapEx</tt> instance: the keys
	...
	protected Object clone() throws CloneNotSupportedException {
        AbstractMapEx<K,V> result = (AbstractMapEx<K,V>)super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
